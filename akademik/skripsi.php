...
<div class="profile-section py-5 text-white" 
  ...
  <div class="container" style="max-width: 900px;"> 
    <h2 class="fw-bold text-center mb-4">Tentang Sistem Skripsi</h2>
    <p class="lead text-center mb-5 text-white" style="line-height:1.8; font-size:1.1rem;">
      Sistem Skripsi Online ini merupakan platform digital yang membantu mahasiswa, dosen pembimbing, serta pihak fakultas dalam mengelola seluruh proses skripsi mulai dari pengajuan judul, bimbingan, hingga sidang akhir.
    </p>
  </div>
</div>
